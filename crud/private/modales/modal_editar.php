            ...
            <form id="formEditar" class="px-6 py-4">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" name="nombre" id="editNombre" required class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="tel" name="telefono" id="editTelefono" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    </div>
